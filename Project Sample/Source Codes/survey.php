...
<body>
  <div class="container"> 
    ...
    <div class="jumbotron">
      ...
      <form id="formSurvey" action="survey_record.php?eid=<?php echo $eid;?>" method="post">
        <?php
              ...
              <?php 
                ...
                while ($rowChoices = mysql_fetch_assoc($listChoices)) { ?> <!-- All choices of the Survey's Question -->
                    <div class="radio">
                      <label>
                        <input type="radio" name="<?=$row['id'];?>" id="<?=$rowChoices['id'];?>" value="<?=$rowChoices['id'];?>">
                        <?php echo $rowChoices['content']; ?> </label> <!-- Content of the choice -->
                    </div>
                <?php } ?>
                <br>
                <br>
        ...
        <button type="submit" id="btnSubmit" class="btn btn-success">Gönder</button>
      </form>
